...
public class Admin {
    ...
    public int registerProduct(String productName, String productMake, double price,
            int availability) throws Exception {
        int i = 0;
        Connection con = null;
        try {
            con = ConnectionManager.getConnection();
            String sql = "INSERT INTO product(productName,productMake,price,availability) VALUES(?,?,?,?);";
            PreparedStatement ps = con.prepareStatement(sql);
//            ps.setInt(1, productId);
    ...
    public Product fetchProductDetails(int productId) throws SQLException, Exception {
        ...
        try {
            ...
            String sql = "SELECT productId, productName, productMake, price, "
                    + "availability FROM product WHERE productId=?";
            PreparedStatement ps = con.prepareStatement(sql);
    ...
    public int updateProductDetails(int productId, String productName, String productMake, double price,
        ...
        int i = 0;
        try {
            String sql = "UPDATE product SET productName = ?, productMake = ?, "
                    + " price = ?, availability = ? "
                    + "WHERE productId = ?";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setString(1, productName);
